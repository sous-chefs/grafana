...
load_current_value do |new_resource|
  current_config = load_file_grafana_config_section(new_resource.config_file, 'external_image_storage.gcs')
...
action :create do
  ...
  resource_properties.each do |rp|
    ...
    accumulator_config(:set, rp.to_s, new_resource.send(rp), 'external_image_storage.gcs')
  end
end
