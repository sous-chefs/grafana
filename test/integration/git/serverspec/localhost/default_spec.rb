...
describe file('/srv/apps/grafana/master') do
...
describe file('/srv/apps/grafana/current') do
  it { should be_directory }
  it { should be_linked_to '/srv/apps/grafana/master' }
  it { should be_owned_by 'root' }
  it { should be_grouped_into 'root' }
end

describe file('/srv/apps/grafana/current/src/config.js') do
  it { should be_file }
